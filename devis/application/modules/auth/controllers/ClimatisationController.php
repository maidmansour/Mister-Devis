...
class Auth_ClimatisationController extends Zend_Controller_Action
{
	...
	public function editAction(){
		...
		$climatisation = $this->getRequest()->_em->getRepository('Auth_Model_Climatisation')->findBy(array('id_demande' => $id));
	...
	public function sendMail($email,$activite,$zone,$username,$id_demande){
		...
		$activite=$this->getRequest()->_em->getRepository('Auth_Model_Activite')->findBy(array('libelle' => $activite));
